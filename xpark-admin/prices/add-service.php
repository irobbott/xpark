                ...
                <div class="sct" style="margin-bottom: 60px;">
                    ...
                    <form action="" method="post">
                        ...
                        <div class="form-group mb-4">
                            ...
                            <input type="number" name="service_price" class="form-control" value="<?php echo $service_price; ?>">
                        </div>
                        <div class="form-group mb-4">
                            <label for="">Description (short description)</label>
                            <input type="text" name="service_desc" class="form-control" value="<?php echo $service_desc; ?>">
                        </div>
                        <div class="form-group mb-4">
